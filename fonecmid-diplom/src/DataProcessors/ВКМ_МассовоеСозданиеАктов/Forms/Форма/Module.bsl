...
Функция СоздатьДокументыНаСервере()
	...
	Возврат ДлительныеОперации.ВыполнитьФункцию(ПараметрыВыполнения, Обработки.ВКМ_МассовоеСозданиеАктов.СоздатьСписокДокументовРеализацииТоваровИУслуг(Объект.Период.ДатаНачала, Объект.Период.ДатаОкончания ),
